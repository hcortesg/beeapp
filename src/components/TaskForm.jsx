  ...
  return (
    <div className='max-w-md' >
      ...
      className="bg-purple-100 text-yellow-700 text-xl bold p-2">
        <p className='font-bold'>Actividad a programar</p>
        <input autoFocus value={title} placeholder='Actividad a programar'
          onChange={(e) => {
        ...
        />
        <textarea value={detail} placeholder='Detalle de la tarea'
        onChange={(e) => {
          // console.log(e.target.value)
